...
export async function UpdateSchoolMiddleware(request: Request, response: Response, next: NextFunction) {
...
export async function CreateSchoolMiddleware(request: Request, response: Response, next: NextFunction) {
