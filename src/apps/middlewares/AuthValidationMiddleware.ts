...
export async function StudentAuthValidationMiddleware(request: Request, response: Response, next: NextFunction) {
...
export async function TeacherAuthValidationMiddleware(request: Request, response: Response, next: NextFunction) {
...
export async function ManagerAuthValidationMiddleware(request: Request, response: Response, next: NextFunction) {
